...
<div class="card">
    <div class="card-body">
      ...
      <a href="/dashboard/nilai/create" class="btn btn-success mb-3"><i class="bi bi-plus-circle"> Tambah Nilai Baru</i></a>
      {{-- <button type="button" class="btn btn-success mb-3" href=""><i class="bi bi-plus-circle"></i> Tambah Nilai</button> --}}
        ...
        <tbody>
          @forelse ($penilaians as $penilaian)
              <tr>
                ...
                <td>
                  <form action="/dashboard/nilai/{{ $penilaian->id }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
