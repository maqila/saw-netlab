...
<div class="card">
    <div class="card-body">
      <h5 class="card-title">Tambah Data Asisten Laboratorium</h5>
      <form action="/dashboard/aslab" method="post">
        @csrf
        <div class="row mb-3">
        ...
        <div class="row mb-3">
          <label for="lab_id" class="form-label">Nama Laboratorium</label>
            <div class="col-sm-12">
              <select name="lab_id" class="form-control">
                <option class="disable" value="">---Pilih Laboratorium---</option>
                @foreach($labs as $lab)
